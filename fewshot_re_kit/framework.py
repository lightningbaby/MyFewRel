...
class FewShotREFramework:
    ...
    def train(self,
        ...
        for it in range(start_iter, start_iter + train_iter):
            ...
            else:#support 里有mask pos1 pos2 word,每一个都是[200,128] 4*10*5=B*trainN*K 每一轮label都是0-9，每一类5个
                support, query, label = next(self.train_data_loader)#support，query公用一个label
                if torch.cuda.is_available():
                    for k in support:
